"""
Django settings for cruzroja project.
...
DEBUG = True if os.environ['DEBUG'] == '1' else 0
print(DEBUG)
...
WSGI_APPLICATION = 'cruzroja.wsgi.application'
...
if 'RDS_HOSTNAME' in os.environ:
    print(os.environ['RDS_DB_NAME'],os.environ['RDS_USERNAME'])
DATABASES = {
    'default': {
